package com.component.oliveira.nathan.tour.component
...
import com.component.oliveira.nathan.tour.R
import kotlinx.android.synthetic.main.tourguide_tooltip.view.*
import net.i2p.android.ext.floatingactionbutton.FloatingActionButton
import com.component.oliveira.nathan.tour.component.util.locationOnScreen
        ...
        toolTip?.also { _toolTip ->
            ...
            if (_toolTip.getCustomView() == null) {
                ...
                toolTipView?.apply {
                    ...
                    toolTipContainer.background = _toolTip.mBackground
